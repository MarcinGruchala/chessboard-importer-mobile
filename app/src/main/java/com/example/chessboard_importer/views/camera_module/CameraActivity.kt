...
import com.example.chessboard_importer.viewmodels.CameraModuleViewModel
...
class CameraActivity : AppCompatActivity() {
    ...
    private val cameraViewModel: CameraModuleViewModel by viewModels()
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                ...
                override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                    ...
                    cameraViewModel.createPhotoData(savedUri)
